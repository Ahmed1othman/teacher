                ...
                <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute" id="notificationDropdown">
                    <div class="scroll">
                        ...
                        <div class="d-flex flex-row mb-3 pb-3 ">
                            <div class="pl-3">
                                <a href="{{route('projectNotification',[$notification->id,$notification->data['type']])}}">
                                    <p class="font-weight-medium mb-1">{{$notification->data['text']}}
                                    </p>
                                    <p class="text-muted mb-0 text-small">{{ $notification->created_at }}</p>
                                </a>
                            </div>
                        </div>
